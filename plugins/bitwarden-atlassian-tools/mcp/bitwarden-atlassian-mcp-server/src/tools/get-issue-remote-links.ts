...
const getIssueRemoteLinksTool: ToolDefinition = {
  ...
  description:
    "Get all remote links for a JIRA issue. Returns linked Confluence pages, GitHub PRs, and other external resources connected to the issue. Useful for discovering related documentation and pull requests.",
  inputSchema: {
    type: "object",
    properties: {
      issueIdOrKey: {
