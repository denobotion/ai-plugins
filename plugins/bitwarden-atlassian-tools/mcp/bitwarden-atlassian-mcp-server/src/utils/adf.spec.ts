      ...
      content: [
        ...
        },
        {
          ...
          content: [
            ...
            {
              type: "inlineCard",
              attrs: { url: "https://jira.example.com/PROJ-1" },
            },
          ],
        },
        {
...
describe("extractPlainTextTruncated", () => {
  ...
  it("should handle mixed content types in truncated extraction", () => {
    ...
    expect(extractPlainTextTruncated(adf)).toBe(
      "Hello @Bob see https://example.com",
    );
  });
